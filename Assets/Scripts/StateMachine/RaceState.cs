...
public class RaceState : State
{
    ...
    public override void Update()
    {
        ...
        if(updateBackground > 1.5f)
        {
            SceneObjects["Background"].GetComponent<Image>().color = Color.Lerp(Color.red, Color.yellow, (3.0f - updateBackground) / 1.5f);
            updateBackground -= Time.deltaTime;
        }
        else if(updateBackground > 0.0f)
        {
            SceneObjects["Background"].GetComponent<Image>().color = Color.Lerp(Color.yellow, Color.green, (1.5f - updateBackground) / 1.5f);
            updateBackground -= Time.deltaTime;
        }
    }
